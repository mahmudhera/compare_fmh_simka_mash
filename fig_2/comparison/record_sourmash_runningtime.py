...
for filesize, filename in filesize_to_filename.items():
    ...
    f.write(f"{filesize},{avg_sourmash_time},{std_sourmash_time}\n")
    f.flush()
    print(f"filesize: {filesize}, avg_sourmash_time: {avg_sourmash_time}, std_sourmash_time: {std_sourmash_time}")
f.close()
